      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 py-8 space-y-6">
        ...
        <div className="space-y-1">
          <h1 className="text-xl sm:text-2xl font-bold text-white tracking-tight flex items-center gap-2">
            <Bell className="w-5 h-5 text-amber-400" /> Workspace Invitations
          </h1>
        ...
        {pendingInvitations.length === 0 ? (
          <div className="rounded-lg border border-dashed border-slate-800 bg-slate-900/40 p-10 text-center space-y-3">
            <div className="w-11 h-11 rounded-md bg-amber-500/10 text-amber-400 flex items-center justify-center mx-auto border border-amber-500/20">
              <Bell className="w-5 h-5" />
            </div>
            <h3 className="text-xs sm:text-sm font-semibold text-white">No Pending Invitations</h3>
            <p className="text-xs text-slate-400">
              ...
              >
                ...
                <div className="flex items-center gap-2.5 w-full sm:w-auto pt-3 sm:pt-0 border-t sm:border-t-0 border-slate-800">
                  <button
                    ...
                    className="flex-1 sm:flex-initial px-3.5 py-2 rounded-md bg-slate-800 hover:bg-slate-700 text-slate-300 text-xs font-medium transition-colors"
                  >
                    Reject
                  </button>
                  <button
